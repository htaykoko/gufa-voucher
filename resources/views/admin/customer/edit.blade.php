                                ...
                                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    <div class="grid grid-cols-3 gap-6">
                                        ...
                                        <div class="col-span-3 sm:col-span-2">
                                            ...
                                            <div class="mt-1 flex rounded-md shadow-sm">
                                                <input type="text" value="{{ old('code', $customer->code) }}"
                                                    name="code" id="code"
                                                    class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
                                    ...
                                    <div class="grid grid-cols-3 gap-6">
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" value="{{ old('phone', $customer->phone) }}"
                                                name="phone" id="phone" autocomplete="given-name"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" value="{{ old('mobile', $customer->mobile) }}"
                                                name="mobile" id="mobile" autocomplete="family-name"
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <select id="gender" name="gender" autocomplete="gender-name"
                                                ...
                                                <option {{ old('gender', $customer->gender) == 1 ? 'selected' : '' }}>
                                                    Active</option>
                                                <option {{ $customer->gender == 0 ? 'selected' : '' }}>In-Active
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <select id="status" name="status" autocomplete="status-name"
                                                class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                <option {{ old('status', $customer->status) == 1 ? 'selected' : '' }}>
                                                    Active</option>
                                                <option {{ old('status', $customer->status) == 0 ? 'selected' : '' }}>
                                                    In-Active
                                                </option>
                                            </select>
                                        </div>
