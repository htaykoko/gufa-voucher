                    ...
                    <div class="items-center flex">
                        <span
                            class="w-12 h-12 text-sm text-white bg-blueGray-200 inline-flex items-center justify-center rounded-full"><img
                                ...
                                src="{{ asset('images/gufa_logo.jpg') }}" /></span>
                    </div>
                </a>
                <div class="hidden bg-white text-base z-50 float-left py-2 list-none text-left rounded shadow-lg mt-1"
        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden"
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                <li class="items-center">
                    <a class="{{ activeSegment(2, 'dashboard') == 'active' ? 'text-pink-500' : '' }} hover:text-pink-600 text-xs uppercase py-3 font-bold block"
                        href="{{ route('admin.dashboard') }}"><i class="fas fa-tv opacity-75 mr-2 text-sm"></i>
                        Dashboard</a>
                </li>
                <li class="items-center">
                    <a class="{{ activeSegment(2, 'customers') == 'active' ? 'text-pink-500' : '' }} text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                        href="{{ route('admin.customers.index') }}"><i
                            class="fas fa-newspaper text-blueGray-400 mr-2 text-sm"></i>
                        Customer</a>
                </li>
                <li class="items-center">
                    <a class="{{ activeSegment(2, 'orders') == 'active' ? 'text-pink-500' : '' }} text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
                        href="{{ route('admin.orders.index') }}"><i
                            class="fab fa-product-hunt text-blueGray-400 mr-2 text-sm"></i>
                        Order</a>
                </li>
                <li class="items-center">
                    <a class="{{ activeSegment(2, 'users') == 'active' ? 'text-pink-500' : '' }} text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block"
